  ...
  return (
    <div className={styles.wrapper}>
      <div className={styles.img_wrap}>
        <img src={Images.heroExplore} alt="explore" />
      </div>
      <SVGS.HeroDesign className={styles.heroDesign} />
      <div className={`container ${styles.content_wrap}`}  dir={context.state.locale === "sa" ? "rtl" : "ltr"}>
        <h1 className={styles.heading} style={{textAlign: 'start'}}><FormattedMessage id="WHAT ARE YOU IN THE MOOD FOR?" /></h1>
        <div className="parent mt-50 ">
          <div className="d-flex flex-column align-items-center justify-content-between">
            <SVGS.EventMusic className="mb-30" />
            <h3 className="text-light ff-bakbak mb-0"><FormattedMessage id="MUSIC" /></h3>
          </div>{" "}
          <div className="d-flex flex-column align-items-center justify-content-between">
            <SVGS.EventArt className="mb-30" />
            <h3 className="text-light ff-bakbak mb-0"><FormattedMessage id="ART" /></h3>
          </div>
          <div className="d-flex flex-column align-items-center justify-content-between">
            <SVGS.EventSites className="mb-30" />
            <h3 className="text-light ff-bakbak mb-0"><FormattedMessage id="SITES" /></h3>
          </div>
          <div className="d-flex flex-column align-items-center justify-content-between">
            <SVGS.EventSports className="mb-30" />
            <h3 className="text-light ff-bakbak mb-0"><FormattedMessage id="SPORT" /></h3>
          </div>
          <div className="d-flex flex-column align-items-center justify-content-between">
            <SVGS.EventGame className="mb-30 mt-20" />
            <h3 className="text-light ff-bakbak mb-0"><FormattedMessage id="GAMES" /></h3>
          </div>
        </div>
        <Slider ref={slider2Ref} {...settings} className="d-lg-none mt-30">
          {" "}
          <div className="d-flex flex-column align-items-center justify-content-between">
            <SVGS.EventMusic className="mb-30" />
            <h3 className="text-light ff-bakbak mb-0"><FormattedMessage id="MUSIC" /></h3>
        ...
        <div className="d-flex align-items-center justify-content-center mt-30 d-lg-none">
